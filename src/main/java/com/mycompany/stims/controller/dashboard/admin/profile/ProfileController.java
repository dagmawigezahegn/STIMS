package com.mycompany.stims.controller.dashboard.admin.profile;
...
/**
 * The `ProfileController` class manages the admin profile functionality in the
 * admin dashboard. It allows admins to view their profile, change their
 * username, and update their password.
 */
